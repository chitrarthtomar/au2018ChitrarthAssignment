...
public class StudentServiceTest {
	...
	Student student=new Student(1, "Chitrarth", "tomar", "BMSCE", new Date(1996, 03, 8), 12345, 33, "cse");
	@SuppressWarnings("deprecation")
	Student student1=new Student(0, "Raj", "maan", "BMSCE", new Date(1994, 8, 15), 12345, 3, "cse");
	@SuppressWarnings("deprecation")
	Student student2=new Student(7, "rAvi", "jain", "BMSCE", new Date(1994, 10, 12), 3780, 45, "cse");
