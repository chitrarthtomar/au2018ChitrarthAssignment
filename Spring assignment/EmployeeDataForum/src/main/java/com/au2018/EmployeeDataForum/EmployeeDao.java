...
public class EmployeeDao {  
	...
	public int addEmployee(Employee e){  
	    String query="insert into employees values('"+e.getEid()+"','"+e.getEname()+"','"+e.getEage()+"')";  
	    return jdbcTemplate.update(query);  
	}  
	public int updateEmployee(Employee e){  
	    String query="update employees set ename='"+e.getEname()+"',eage='"+e.getEage()+"' where eid='"+e.getEid()+"' ";  
	    return jdbcTemplate.update(query);  
	}  
